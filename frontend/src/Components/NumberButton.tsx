...
export default function NumberButton() {
    ...
    const classes = {
        mainDiv : "flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1",
        ...
        minusIcon : "m-auto text-2xl font-semibold",
        addIcon: "m-auto text-2xl font-semibold",
    ...
    return (
        <div className={classes.mainDiv}>
            ...
            <span className={classes.minusIcon}>−</span>
            </button>
            <input 
                type="number" 
